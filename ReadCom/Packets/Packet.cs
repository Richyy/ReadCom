...
namespace ReadCom.Packets
{
    ...
    {
        protected readonly int _packetId;
        protected readonly DateTime _createdAt = DateTime.Now;
        protected int _packetType = (int)ServerPacketTypes.unknown;

        public int PacketType => _packetType;
        ...
        public Packet(byte[] _data, int packetId=0)
        {
            _packetId = packetId;
            buffer = new List<byte>(); // Intitialize buffer
            readPos = 0; // Set readPos to 0
        ...
        public string ReadString(bool _moveReadPos = true)
        {
            try
            {
                int _length = readableBuffer.Length-readPos; // Get the length of the string
                string _value =
